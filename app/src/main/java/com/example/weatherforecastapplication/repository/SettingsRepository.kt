...
class SettingsRepository(private val context: Context) {
    ...
    companion object {
        ...
        val HOME_LAT = androidx.datastore.preferences.core.doublePreferencesKey("home_lat")
        val HOME_LON = androidx.datastore.preferences.core.doublePreferencesKey("home_lon")

        // ADD THESE FOR REAL GPS
        val GPS_LAT = androidx.datastore.preferences.core.doublePreferencesKey("gps_lat")
        val GPS_LON = androidx.datastore.preferences.core.doublePreferencesKey("gps_lon")
